...
### 2. Resguardar la Interpretabilidad (El POR QUÉ)
...
### 3. Marco Teórico Vivo (MTV) y Ruteo por Tipo de Grafo
...
### 4. Memoria en la Capa Frontera del Repositorio
...
### 5. Modelo Local-First e Independencia de Herramientas Endémicas
...
### 6. Regla de 3 Intentos y Ancla Temporal ISO-8601
- **Regla de 3 Intentos**: Si una tarea o comando falla 3 veces consecutivas, **DETENERSE y consultar al Guardián**.
- **Firma Temporal**: Todo reporte u orden debe llevar timestamp ISO-8601 con offset numérico explícito (ej. `2026-08-04T09:28-06:00`), sin abreviaturas como `CST`.
